-- EquityMirror MySQL schema
CREATE DATABASE IF NOT EXISTS `quntm_equitymirror` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `quntm_equitymirror`;
